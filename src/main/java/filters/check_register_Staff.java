...
@WebFilter(urlPatterns = { "/admin/Staff/store"}, filterName = "check_register_Staff")
public class check_register_Staff extends HttpFilter implements Filter {

	public check_register_Staff() {
		super();
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (fullname.length() <= 0 ) {
			...
			httpResp.sendRedirect(httpReq.getContextPath() + "/admin/Staff/create" + "?error1=5");
			return;
