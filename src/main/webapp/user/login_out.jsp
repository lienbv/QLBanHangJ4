...
<div class="row py-2 ">
	<div class="col-sm-12">
		<div class="row bg-white px-0 justify-content-center">
			...
			<div class="col-sm-5">
				<label class="text-center py-sm-2" style="padding-left: 40%;">Login</label>
				<form action="/ASMJ4/user/login" method="post">

					<div class="form-group">
						<label for="usename">Username</label> <input name="username"
							type="text" class="form-control" id="usename" required="required"
							aria-describedby="usename">
					</div>
					<div class="form-group">
						<label for="pass">Password</label> <input name="password"
							type="password" class="form-control" id="passs">
					</div>
					<div class="form-group">
						<button type="submit" class="btn btn-dark col-sm-12"
							style="border: 1px solid black;">Submit</button>
					</div>
				</form>
				<div class="pb-sm-2">
					<a href="" class="text-center text-dark " data-toggle="modal"
						data-target="#staticBackdrop1" style="padding-left: 40%;">Forgot
						Password</a>
				</div>
				<a href=""
					class="btn btn-secondary text-center text-white col-sm-12 py-2">G+</a>
				<!-- Forgot pass -->
			...
			<div class="col-sm-5">
				...
				<form action="/ASMJ4/user/register" method="post">
					<div class="form-group">
					...
					<div class="form-group">
						<label for="email">Email</label> <input type="email"
							...
							minlength="5" maxlength="50" id="email" aria-describedby="email">
					...
					<div class="form-group">
						<label for="sdt">Phone number</label> <input required="required"
							...
							onchange="checkFormPhone()" required class="form-control"
							id="sdt" aria-describedby="sdt">
	...
	<div class="modal-dialog modal-lg modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header text-center bg-dark"
				style="margin: -0.5px -0.4px 0 0;">
				<h5 class="modal-title text-white bg-dark" id="staticBackdropLabel"
					style="margin: auto;">Forgot Password</h5>
			</div>
			<div class="modal-body">
				<div class="col-sm-12">
					<form action="/ASMJ4/user/Forgotpassword" method="post">
						<div class="form-group">
							<label for="usename">Username</label> <input name="username"
								type="text" class="form-control" id="usename"
								required="required" aria-describedby="usename">
						</div>
						<div class="form-group">
						...
						<div class="form-group row">
							<button type="submit" class="btn btn-dark col-sm-12 mr-auto"
								style="border: 1px solid black;">Submit</button>
