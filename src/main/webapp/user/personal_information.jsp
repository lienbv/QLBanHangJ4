				...
				<div class="tab-content" id="v-pills-tabContent">
					<div class="tab-pane fade show active" id="v-pills-home"
						...
						<c:if test="${!empty sessionScope.successUpdateProfile}">
							...
							<form action="/ASMJ4/profile_Infor/update?id=${customer.id }" method="post" class="bg-light">
					...
					<div class="tab-pane fade px-sm-2" id="v-pills-profile"
						...
						<h4 class="text-center py-sm-2" style="color: rgb(75, 73, 72);">Change
							password</h4>
						<form action="/ASMJ4/profile_Infor/changePassword?id=${customer.id }" method="post" class="bg-light">
							...
							<div class="form-group">
								<label for="pass_new">Password new</label> <input
									name="pass_new" type="password" minlength="5" maxlength="10" required="required" class="form-control" id="pass_new"
